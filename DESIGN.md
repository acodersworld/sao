...
1. [1. Design goals](design/01-design-goals.md)
2. [2. Compilation model](design/02-compilation-model.md)
3. [3. Static typing and inference](design/03-static-typing-and-inference.md)
...
11. [11. Lexical `defer`](design/11-lexical-defer.md)
12. [12. Backend-oriented lowering](design/12-backend-oriented-lowering.md)
13. [13. Runtime representation and memory management](design/13-runtime-representation-and-memory-management.md)
...
21. [21. Tracked non-GC references](design/21-tracked-non-gc-references.md)
